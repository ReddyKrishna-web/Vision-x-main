      ...
      {s?.sync && (
        <div className="card-flat mt-3 flex flex-wrap items-center justify-between gap-2">
          <p className="text-sm">
            ...
            <span className="text-slate-500"> — last updated {s.sync.lastSyncedAt ? String(s.sync.lastSyncedAt).slice(0, 16).replace('T', ' ') : 'never'} · {s.sync.pending} pending · {s.sync.failed} failed</span>
          </p>
